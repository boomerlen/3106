...
avr-gcc -g -mmcu=attiny461a -O3 -DMODE_SINGLE_SHOT -DF_CPU=1000000LU -o build/bin/main.elf build/obj/main.o build/obj/ADC.o build/obj/FreqGen.o build/obj/AC.o build/obj/delay.o build/obj/Display.o build/obj/GPIO.o
